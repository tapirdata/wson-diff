...
export default [
  ...
  },
  {
    ...
    have: (function() { let x = {foo: {a: {y: 3}}}; return x; })(),
    wish: (function() { let x = {foo: {a: {y: 3}}}; x.foo.a.x = x; return x; })(),
    delta: '|foo|a|x:|2'
  },
  {
    description: 'add circular reference',
    have: (function() { let x = {foo: {a: {y: 3}}}; return x; })(),
    wish: (function() { let x = {foo: {a: {y: 3}}}; x.foo.a.foo = x.foo; return x; })(),
    delta: '|foo|a|foo:|1'
  },
  {
    description: 'move circular array reference',
    have: (function() { let x = [1, 2, 3, null]; x[3] = x; return x; })(),
    wish: (function() { let x = [null, 1, 2, 3]; x[0] = x; return x; })(),
    delta: '|[m3@0]'
  },
  {
  ...
  },
  {
    ...
    diffOptions: { arrayLimit() { return 2; }
  },
    have: 'abcdefghijkl'.split(''),
    wish: 'abcDEfghijkl'.split(''),
